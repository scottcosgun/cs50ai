...
def load_data(data_dir):
    ...
    # List all entries in the data_dir directory
    ...
    for entry in entries:
        ...
        for img_file in os.listdir(entry_path):
            ...
            # Resize image to have IMG_WIDTH and IMG_HEIGHT
            resized = cv2.resize(src=img, dsize=(IMG_WIDTH, IMG_HEIGHT), interpolation=cv2.INTER_AREA)

            # Add image (numpy array) and its label (int) to their corresponding lists
...
def get_model():
    ...
    model = tf.keras.models.Sequential([
        ...
        # Dropout to remove 10% of neurons
        ...
        # Add dropout to remove 20% of neurons
        tf.keras.layers.Dropout(0.2),

        # Add an output layer with NUM_CATEGORIES neurons for all categories
